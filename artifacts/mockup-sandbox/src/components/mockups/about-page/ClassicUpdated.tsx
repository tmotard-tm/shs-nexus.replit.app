...
export function ClassicUpdated() {
  return (
  ...
  return (
    <div className="p-4 rounded-lg bg-muted/50 space-y-2">
      <div className="flex items-center gap-2">
        <Badge variant="outline" className={props.badgeClass}>{props.name}</Badge>
      </div>
...
function Capability(props: { icon: React.ReactNode; title: string; desc: string }) {
  return (

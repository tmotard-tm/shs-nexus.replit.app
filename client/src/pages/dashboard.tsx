  ...
  return (
    <MainContent>
      ...
      <main className="p-6">
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4">Productivity Dashboard by Department</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-sm font-medium">Assets Management</CardTitle>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-sm font-medium">Inventory Control</CardTitle>

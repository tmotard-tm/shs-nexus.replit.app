...
import { type MetricsSnapshot } from "@shared/fleet-scope-schema";
...
export default function MetricsDashboard() {
  ...
  const captureMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/fs/metrics"] });
      queryClient.invalidateQueries({ queryKey: ["/api/fs/metrics/weekly"] });
      toast({

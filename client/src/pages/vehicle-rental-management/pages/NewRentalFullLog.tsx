...
function exportEntriesToCsv(rows: RentalLogEntry[]) {
  // Screen columns in screen order first; extra data fields trail.
  const header = [
    "Date of Request",
    "Rental Vehicle #",
    "Decision",
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <button
                  ...
                  style={{
                    ...
                    padding: "5px 14px",
                    borderRadius: 5,
                    border: `1px solid ${localApproved === true ? colors.green : colors.rule}`,
                    backgroundColor: localApproved === true ? colors.greenLight : colors.surface,
                    color: localApproved === true ? colors.green : colors.inkMuted,
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: "5px 14px",
                    borderRadius: 5,
                    border: `1px solid ${localApproved === false ? colors.red : colors.rule}`,
                    backgroundColor: localApproved === false ? colors.redLight : colors.surface,
                    color: localApproved === false ? colors.red : colors.inkMuted,
                    cursor: (isEdit && actionPatchMutation.isPending) ? "not-allowed" : "pointer",
                    opacity: (isEdit && actionPatchMutation.isPending) ? 0.7 : 1,
                  }}
                >
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: "5px 14px",
                    borderRadius: 5,
                    border: `1px solid ${localDeclined ? colors.red : colors.rule}`,
                    backgroundColor: localDeclined ? colors.redLight : colors.surface,
                    color: localDeclined ? colors.red : colors.inkMuted,
                    cursor: (isEdit && actionPatchMutation.isPending) ? "not-allowed" : "pointer",
                    opacity: (isEdit && actionPatchMutation.isPending) ? 0.7 : 1,
                  }}
                >
          ...
          <div style={{ display: "flex", gap: 4, alignItems: "center" }} onClick={(ev) => ev.stopPropagation()}>
            <button
              ...
              style={{
                ...
                padding: "2px 9px",
                borderRadius: 5,
                // Theme-aware so unselected pills don't render white-on-dark in dark mode
                border: `1px solid ${e.rentalApproved ? colors.green : colors.rule}`,
                backgroundColor: e.rentalApproved ? colors.greenLight : colors.surface,
                color: e.rentalApproved ? colors.green : colors.inkMuted,
            ...
            <button
              ...
              style={{
                ...
                padding: "2px 9px",
                borderRadius: 5,
                border: `1px solid ${!e.rentalApproved ? colors.red : colors.rule}`,
                backgroundColor: !e.rentalApproved ? colors.redLight : colors.surface,
                color: !e.rentalApproved ? colors.red : colors.inkMuted,
                cursor: pending ? "not-allowed" : "pointer",
                opacity: pending ? 0.6 : 1,
                transition: "all 0.12s",
              }}
          ...
          <div onClick={(ev) => ev.stopPropagation()}>
            <button
              ...
              style={{
                ...
                padding: "2px 9px",
                borderRadius: 5,
                // Theme-aware: prevents white-pill-on-dark-background in dark mode
                border: `1px solid ${e.declinedRepair ? colors.red : colors.rule}`,
                backgroundColor: e.declinedRepair ? colors.redLight : colors.surface,
                color: e.declinedRepair ? colors.red : colors.inkMuted,
                cursor: pending ? "not-allowed" : "pointer",
                opacity: pending ? 0.6 : 1,
                transition: "all 0.12s",
              }}

...
export function checkRouteAccess(user: User | null, route: string, permissions?: RolePermissionSettings): boolean {
  ...
  const routePermissions: Record<string, () => boolean> = {
    ...
    '/cost-centers': () => perms.sidebar.management.costCenterManagement,
    '/cost-center-management': () => perms.sidebar.management.costCenterManagement,
    '/external-app-management': () => perms.sidebar.management.externalAppManagement,

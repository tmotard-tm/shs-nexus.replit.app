...
**How to apply:** all ranked risks are closed; remaining softness is the toast-only surfacing of off-page (non-booked) conflicts. Any new work on this detector follows the standing rules above — silent false negatives beat cosmetic fixes.

...
- The hand-booking residual closes WITHOUT loosening identity (2026-08-21): staff attach a known confirmation (which then identifies normally — the work claim must carry it or the attach never reaches the search), and unidentified confirmation-bearing sightings travel as ADVISORY evidence the cancel lane refuses to settle terminal on. Advisories never enter matches, and they omit the journey's free-text reference (branch-typed, can carry a person's name).
